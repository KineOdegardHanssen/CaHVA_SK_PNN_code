...
if __name__ == '__main__':
    ...
    for j in range(Namps):
        ...
        if Nspikes[j]!=0:
            ...
            # Write all durs:
            outfilename_durs_all = infolder+'somaHjorth_idur%i_iamp'% (idur)+str(iamp) +'_manual_cmf'+str(cm)+'_'+str(v_init)+'_trec'+str(t_before_rec)+'_alldurs_s'+str(skiptime)+'.txt'
            figname_durs_all     = infolder+'somaHjorth_idur%i_iamp'% (idur)+str(iamp) +'_manual_cmf'+str(cm)+'_'+str(v_init)+'_trec'+str(t_before_rec)+'_alldurs'+str(skiptime)+'.png'
            ...
            outfilename_pt_all = infolder+'somaHjorth_idur%i_iamp'% (idur)+str(iamp) +'_manual_cmf'+str(cm)+'_'+str(v_init)+'_trec'+str(t_before_rec)+'_peaktimes'+str(skiptime)+'.txt'
            ...
            # Write all ISIs:
            outfilename_ISI_all = infolder+'somaHjorth_idur%i_iamp'% (idur)+str(iamp) +'_manual_cmf'+str(cm)+'_'+str(v_init)+'_trec'+str(t_before_rec)+'_ISIall'+str(skiptime)+'.txt'
