...
ax3.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{CaHVA}}$' % (5.0*gcahvas[2]),fontsize=18)
ax4.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{CaHVA}}$' % (5.0*gcahvas[3]),fontsize=18)
...
ax5.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{SK}}$' % gsks[0],fontsize=18)
ax6.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{SK}}$' % gsks[1],fontsize=18)
ax7.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{SK}}$' % gsks[2],fontsize=18)
ax8.set_title(r'$f-I$-plot, %.1f$\bar{g}_{\mathregular{SK}}$' % gsks[3],fontsize=18)
