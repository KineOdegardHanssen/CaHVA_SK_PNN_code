...
def return_allen_cell_model(model_folder, cm_factor, somasize, idur,iamp,idelay,tstop,dtexp,gnaf,gkaf,gcahva,gpas,vary_naf,vary_kaf,vary_Ca_HVA,vary_gpas,varyE,varymech,v_init,t_before_rec,vshift):
...
if __name__ == '__main__':
    ...
    for i in range(Ni):
        ...
        for j in range(Ng):
            ...
            t, v = return_allen_cell_model(model_folder,cm_factor,somasize,idur,iamp,idelay,tstop,dtexp,gnaf,gkaf,gcahva,gpas,vary_naf,vary_kaf,vary_Ca_HVA,vary_gpas,varyE,varymech,v_init,t_before_rec,vshift)
